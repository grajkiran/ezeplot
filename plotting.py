...
class Figure:
    ...
    def clear(self, tmax = 1.0):
        ...
        self.ax_x.set_xlabel(r't$\rightarrow$')
        self.ax_y.set_xlabel(r't$\rightarrow$')
        self.ax_z.set_xlabel(r't$\rightarrow$')
        self.ax_x.set_ylabel(r'x$\rightarrow$')
        self.ax_y.set_ylabel(r'y$\rightarrow$')
        self.ax_z.set_ylabel(r'z$\rightarrow$')
